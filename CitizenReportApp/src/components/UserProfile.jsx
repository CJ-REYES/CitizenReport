  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      <View style={tw`space-y-6`}>
        {/* Profile Header */}
        <View style={tw`bg-gray-50 rounded-xl p-6 border border-gray-200`}>
          <View style={tw`flex-row items-center gap-4`}>
            <View style={tw`w-20 h-20 bg-yellow-100 rounded-full items-center justify-center`}>
            ...
            <View style={tw`flex-1`}>
              ...
              <View style={tw`flex-row items-center gap-2 mb-3`}>
                ...
                <Text style={tw`text-lg text-yellow-500 font-semibold`}>{userStats.rank}</Text>
              </View>
        ...
        <View style={tw`flex-row flex-wrap justify-between`}>
          {/* Puntos */}
          <View style={tw`w-[48%] bg-white rounded-xl p-4 mb-4 border border-gray-200`}>
            <View style={tw`flex-row items-center gap-3 mb-2`}>
              <Icon name="trophy" size={24} color="#3B82F6" />
              <Text style={tw`text-gray-500`}>Puntos</Text>
            </View>
            <Text style={tw`text-2xl font-bold text-gray-900`}>{userStats.points}</Text>
          </View>
          ...
          <View style={tw`w-[48%] bg-white rounded-xl p-4 mb-4 border border-gray-200`}>
            <View style={tw`flex-row items-center gap-3 mb-2`}>
              ...
              <Text style={tw`text-gray-500`}>Reportes</Text>
            </View>
            <Text style={tw`text-2xl font-bold text-gray-900`}>{userStats.reportsCount}</Text>
          </View>

          {/* Ranking */}
          <View style={tw`w-[48%] bg-white rounded-xl p-4 border border-gray-200`}>
            <View style={tw`flex-row items-center gap-3 mb-2`}>
              <Icon name="account-group" size={24} color="#8B5CF6" />
              <Text style={tw`text-gray-500`}>Ranking</Text>
            </View>
            <Text style={tw`text-2xl font-bold text-gray-900`}>#{userStats.rankingPosition}</Text>
          </View>
          ...
          <View style={tw`w-[48%] bg-white rounded-xl p-4 border border-gray-200`}>
            <View style={tw`flex-row items-center gap-3 mb-2`}>
              ...
              <Text style={tw`text-gray-500`}>Rango</Text>
            </View>
        ...
        {/* Top 3 Usuarios */}
        <View style={tw`bg-gray-50 rounded-xl p-6 border border-gray-200`}>
          <Text style={tw`text-xl font-bold text-gray-900 mb-4 flex-row items-center gap-2`}>
        ...
        <View style={tw`bg-gray-50 rounded-xl p-6 border border-gray-200`}>
          <View style={tw`flex-row justify-between items-center mb-4`}>
            ...
            <View style={tw`flex-row items-center gap-2`}>
              ...
              <Text style={tw`text-sm text-gray-500`}>Actualizados</Text>
            </View>
          </View>
          ...
          <View style={tw`space-y-3`}>
            {userReports.map((report) => {
              ...
              return (
                <View key={report.id} style={tw`bg-white rounded-lg p-4 flex-row items-start gap-4 border border-gray-200`}>
                  <View style={tw`w-12 h-12 bg-gray-100 rounded-lg items-center justify-center`}>
                    <Icon 
          ...
          <TouchableOpacity style={tw`flex-row justify-center mt-4`}>
