...
const UserProgress = ({ currentUser }) => {
  ...
  return (
    <View style={tw`space-y-4`}>
      {/* Profile Header */}
      <View style={tw`bg-gray-50 rounded-xl p-5 border border-gray-200 mb-4`}>
        <View style={tw`flex-row items-center gap-4`}>
          <View style={tw`w-16 h-16 bg-yellow-100 rounded-full items-center justify-center`}>
            <Icon name="account" size={28} color="#F59E0B" />
          </View>
      ...
      {/* User Stats Grid */}
      <View style={tw`mb-4`}>
        <Text style={tw`text-lg font-bold text-gray-900 mb-3`}>Mis Estadísticas</Text>
        <View style={tw`flex-row flex-wrap justify-between gap-3`}>
          {/* Puntos */}
          <View style={tw`w-[48%] bg-white rounded-xl p-4 border border-gray-200 shadow-sm`}>
            <View style={tw`flex-row items-center gap-2 mb-2`}>
              <Icon name="trophy" size={18} color="#3B82F6" />
              <Text style={tw`text-sm font-medium text-gray-700`}>Puntos</Text>
            </View>
          ...
          <View style={tw`w-[48%] bg-white rounded-xl p-4 border border-gray-200 shadow-sm`}>
            <View style={tw`flex-row items-center gap-2 mb-2`}>
              ...
              <Text style={tw`text-sm font-medium text-gray-700`}>Reportes</Text>
            </View>
            <Text style={tw`text-2xl font-bold text-gray-900`}>{userStats.reportsCount}</Text>
          </View>

          {/* Ranking */}
          <View style={tw`w-[48%] bg-white rounded-xl p-4 border border-gray-200 shadow-sm mt-3`}>
            <View style={tw`flex-row items-center gap-2 mb-2`}>
              <Icon name="account-group" size={18} color="#8B5CF6" />
              <Text style={tw`text-sm font-medium text-gray-700`}>Ranking</Text>
            </View>
          ...
          <View style={tw`w-[48%] bg-white rounded-xl p-4 border border-gray-200 shadow-sm mt-3`}>
            <View style={tw`flex-row items-center gap-2 mb-2`}>
              ...
              <Text style={tw`text-sm font-medium text-gray-700`}>Rango</Text>
            </View>
