...
const UserProfile = ({ currentUser }) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-background backdrop-blur-sm rounded-xl p-6 border border-border">
                <div className="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <h2 className="text-3xl font-bold text-foreground mb-2">{userStats.username}</h2>
            ...
            {/* Recent Reports */}
            <div className="bg-background backdrop-blur-sm rounded-xl p-6 border border-border">
                <h3 className="text-xl font-bold text-foreground mb-4">Mis Reportes Recientes</h3>
                    ...
                    <div className="space-y-3">
                        {userReports.slice(0, 5).map(report => (
                            <div key={report.id} className="bg-muted/50 hover:bg-muted/80 transition-colors rounded-lg p-4 flex items-center gap-4 border border-border">
                                {report.photo && (
                                    <img src={report.photo} alt="Report" className="w-16 h-16 object-cover rounded-lg" />
                                )}
                                ...
                                <div className={`px-3 py-1 rounded-full text-xs ${
                                    ...
                                    report.status === 'reviewed' ? 'bg-sky-500/20 text-sky-300' : 
