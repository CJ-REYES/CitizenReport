...
import { FileText, List, ChevronDown, ChevronUp, LogIn, Shield } from 'lucide-react';
...
const MapPage = ({ currentUser, onPointsEarned }) => {
    ...
    // Si es usuario invitado, mostrar versión protegida
    if (currentUser?.isGuest) {
        return (
            <AuthGuard 
                currentUser={currentUser} 
                action="crear reportes"
            >
                <div className="space-y-6">
                    <div className="flex justify-between items-center">
                        ...
                        <Button 
                            ...
                            onClick={() => {/* AuthGuard manejará esto */}}
                        >
                    ...
                    {/* Lista de Todos los Reportes (solo lectura) */}
    ...
    // Si es usuario normal, mostrar versión completa
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
